        ...
        <tbody>
          @foreach ($user as $u)
            <tr class="odd">
              ...
              <td>{{$u->email}}</td>
                  <td style="text-align: center" ><a href="" class="btn btn-primary " @popper(Chỉnh Sửa)><i class="fa	fa-edit"></i></a>  
                                                  <a href="" class="btn btn-danger " @popper(Hủy Quyền) ><i class="fa fa-ban"></i></a></td>
